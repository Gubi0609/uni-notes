...
- **AIMD** (**A**dditive **I**ncrease **M**ultiplicative **D**ecrease) is used by sender to increase transmission rate (window size) and probe for usable bandwidth until loss occurs [[TCP_continued.pdf#page=31|L6 page 31]]
...
- A lost segment implies congestion. An ACKed segment indicates no congestion [[TCP_continued.pdf#page=32|L6 page 32]]
- **Slow start:** [[TCP_continued.pdf#page=33|L6 page 33]]
	- When connection begins, increase rate exponentially until first loss event
		- Initially **cwnd** = 1 MSS
		- Double **cwnd** every RTT
		- Done by incrementing **cwnd** for every ACK received
		- Resets to **cwnd** = 1 MSS on timeout
	- Initial rate is slow, but ramps up exponentially fast
- **Congestion avoidance** Exponential increase, switch to linear when **cwnd** gets to 1/2 of its (peak) value before timeout [[TCP_continued.pdf#page=35|L6 page 35]]
	- **sstresh** is used to indicate to linear switch.
	- On loss event, **sstresh** is set to 1/2 of **cwnd** just before loss event (thus lowering when switch to linear for next round)
- **Fast recovery:** [[TCP_continued.pdf#page=35|L6 page 35]]
...
- If $K$ TCP sessions share same bottleneck linck of bandwidth $R$, each should have average rate of $R/K$ [[TCP_continued.pdf#page=36|L6 page 36]]

- Multimedia apps (like Netflix, Sotify, etc.) use UDP instead of TCP [[TCP_continued.pdf#page=38|L6 page 38]]
	- Do not want rate throttled by congestion control
	- Sends at constant rate, tolerates some packet loss.
