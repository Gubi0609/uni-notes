- [[#Diskret (x, y)|Diskret (x, y)]]
	- [[#Diskret (x, y)#Marginal PMF|Marginal PMF]]
	- [[#Diskret (x, y)#Betinget PMF|Betinget PMF]]
- [[#Kontinuert (x,y)|Kontinuert (x,y)]]
	- [[#Kontinuert (x,y)#Marginal PDF|Marginal PDF]]
	- [[#Kontinuert (x,y)#Betinget PDF|Betinget PDF]]
- [[#Uafhængige X, Y|Uafhængige X, Y]]
- [[#Momenter for (X,Y)|Momenter for (X,Y)]]
	- [[#Momenter for (X,Y)#Middelværdi|Middelværdi]]
	- [[#Momenter for (X,Y)#Varians|Varians]]
	- [[#Momenter for (X,Y)#Covariance (Covarians)|Covariance (Covarians)]]
	- [[#Momenter for (X,Y)#Korrelation|Korrelation]]
- [[#Linear kombinationer af stokastiske variable|Linear kombinationer af stokastiske variable]]
	- [[#Linear kombinationer af stokastiske variable#Hvis $X_1, ..., X_n$ er _uafhængige_|Hvis $X_1, ..., X_n$ er _uafhængige_]]
	- [[#Linear kombinationer af stokastiske variable#Special case: $Y=c_1X_1+c_2X_2$ **IKKE** uafhængig|Special case: $Y=c_1X_1+c_2X_2$ **IKKE** uafhængig]]
	- [[#Linear kombinationer af stokastiske variable#Ofte brugt linear kombination (gennemsnit af observationer)|Ofte brugt linear kombination (gennemsnit af observationer)]]
- [[#Non-linear funktion af stokastisk variabel|Non-linear funktion af stokastisk variabel]]
---
