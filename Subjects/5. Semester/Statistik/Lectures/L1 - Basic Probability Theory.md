...
> [!DANGER] EXERCISES
> - [x] 2.1.13, 2.1.22, 2.2.7, 2.2.10, 2.3.8, 2.4.2, 2.5.2, 2.5.7, 2.6.5, 2.7.4, 2.7.11-12, 2.8.1
...
- a.
$$P(A)=\frac {7+32}{100}=\frac{39}{100}=0.39$$
- b.
$$P(B)=\frac {13+7}{100}=\frac {20}{100}=0.20$$
- c.
$$P(A|B)=\frac {P(A\cap B)}{P(B)}=\frac {\frac {7}{100}}{0.2}=\frac {0.07}{0.2}=0.35$$
- d.
...
- c.
$$P(E_1|A')=\frac {P(A'|E_1)P(E_1)}{1-0.615}=\frac {0.05\cdot 0.4}{1-0.615}=0.051948052\approx0.052$$
