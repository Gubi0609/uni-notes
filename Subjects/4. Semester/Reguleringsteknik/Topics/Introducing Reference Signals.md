...
## $$\det\left(\left[\begin{array}& A_{CL}-zI & B_{CL} \\ C_{CL} & D_{CL}\end{array}\right]\right)=0$$$$\det\left(\left[\begin{array}& A-zI & BF & BN \\ -LC & A+BF+LC-zI & M \\ C & 0 & 0\end{array}\right]\right)=0$$ $$\det\left(\left[\begin{array}& A-zI & BF-BNN^{-1}F & BN \\ -LC & A+BF+LC-zI-MN^{-1}F & M \\ C & 0 & 0\end{array}\right]\right)=0$$$$\det\left(\left[\begin{array}& A-zI & 0 & BN \\ -LC & A+BF+LC-MN^{-1}F-zI & M \\ C & 0 & 0\end{array}\right]\right)=0$$$$\det\left(\left[\begin{array}& A-zI & 0 & B \\ -LC & A+BF+LC-MN^{-1}F-zI & \tilde M \\ C & 0 & 0\end{array}\right]\right)=0$$$$\left\{\begin{array}& \det\left(\left[\begin{array}& A-zI & B \\ C & 0\end{array} \right]\right)=0 \quad \text{or} \\ \det\left(A+BF+LC\tilde MF-zI \right)=0\end{array}\right.$$
