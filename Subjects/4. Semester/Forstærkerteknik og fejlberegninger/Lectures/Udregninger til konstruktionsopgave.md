...
$$f_{BCL}=\frac {0.7\cdot 10^6}{1+378800/10000}=18004.12 Hz$$
...
$$V_{\text{o,v off}}=\left(1+\frac {R_f}{R_{in}}\right)V_{off}=\left(1+\frac {378800\Omega}{10000\Omega}\right)3\cdot10^{-6}=\pm 116.64\text{ mV}$$ $$V_{\text{o, i off}}=R_f(I_{off}/2)=378800\Omega(2\cdot 10^{-9}A/2)=\pm 378.8\cdot10^{-3} \text{ mV}$$ $$V_{\text{o, bias}}=R_fI_B=378800\Omega\cdot (-20)\cdot10^{-9} A=-7.576 \text{ mV}$$
