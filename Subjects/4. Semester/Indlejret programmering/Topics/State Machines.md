There is a main _super loop_ which will be running all the time, and its functionality will only change upon an [[Subjects/4. Semester/Indlejret programmering/Assignments/Assignment 1 solution|ISR]]
